    ...
    <>
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-base-content/55">Track your products, favorites, purchases, and growth at a glance.</p>
        </div>
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2 xl:grid-cols-5">
        <StatCard icon={BookOpen} label="Total Products" value={data?.recipes} />
        <StatCard icon={Heart} label="Total Favorites" value={data?.favorites} />
        <StatCard icon={ThumbsUp} label="Liked Products" value={data?.likedRecipes} />
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-2">
        ...
        <div className="dashboard-card bg-gradient-to-br from-brand-900 to-brand-600 text-white">
          ...
          <h2 className="mt-4 text-2xl font-bold">Grow your digital brand</h2>
          <p className="mt-2 text-white/65">
            Keep publishing quality products and building trust with customers around the world.
          </p>
