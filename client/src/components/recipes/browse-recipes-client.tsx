  ...
  return (
    <div className="shell section">
      ...
      <div className="mt-6 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div><h1 className="page-title">Explore digital products</h1><p className="mt-2 text-base-content/55">Premium tools, subscriptions and downloads—ready when you are.</p></div>
      ...
      {error ? (
        ...
        <div className="py-24 text-center">
          <PackageSearch size={64} className="mx-auto text-brand-200" />
