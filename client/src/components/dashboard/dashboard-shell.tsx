...
const userNav = [
  ...
  { href: '/dashboard/recipes', label: 'My Products', icon: BookOpen },
  { href: '/dashboard/add', label: 'Add Product', icon: PlusCircle },
  { href: '/dashboard/favorites', label: 'My Favorites', icon: Heart },
  { href: '/dashboard/likes', label: 'Liked Products', icon: ThumbsUp },
...
const adminNav = [
  ...
  { href: '/admin/recipes', label: 'Manage Products', icon: BookOpen },
