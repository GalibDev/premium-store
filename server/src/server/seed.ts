...
async function main() {
  ...
  ['Grammarly Premium', 'photo-1455390582262-044cdead277a', 'Productivity', 'Personal Account', 'Manual', 365, 930, false],
  ['Adobe Creative Cloud', 'photo-1558655146-9f40138edfeb', 'Design & Creative', 'License Key', 'Manual', 30, 884, false],
  ['Spotify Premium', 'photo-1516280440614-37939bbacd81', 'Streaming', 'Personal Account', 'Instant', 90, 810, false],
  ['NordVPN 1 Year', 'photo-1563013544-824ae1b704d3', 'Security', 'License Key', 'Instant', 365, 752, false],
  ['LinkedIn Learning', 'photo-1522202176988-66273c2fd55f', 'Education', 'Shared Access', 'Manual', 180, 695, false],
  ['Notion Premium Template Pack', 'photo-1516321318423-f06f85e504b3', 'Templates', 'Download', 'Instant', 365, 642, false],
  ['GitHub Copilot', 'photo-1555066931-4365d14bab8c', 'Developer Tools', 'Personal Account', 'Manual', 30, 588, false],
  ['Google One 2TB', 'photo-1614064641938-3bbee52942c7', 'Cloud Storage', 'Personal Account', 'Manual', 365, 520, false],
  ['Envato Elements', 'photo-1559028012-481c04fa702d', 'Design & Creative', 'Shared Access', 'Instant', 30, 476, false],
  ['Udemy Business Access', 'photo-1523240795612-9a054b0db644', 'Education', 'Shared Access', 'Manual', 180, 444, false],
  ['Windows 11 Pro Key', 'photo-1624571409108-e9a41746af53', 'Software', 'License Key', 'Instant', 365, 390, false],
] as const;
