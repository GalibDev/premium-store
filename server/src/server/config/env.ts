...
const envSchema = z.object({
  ...
  MONGODB_URI: z.string().min(1).default('mongodb://127.0.0.1:27017/premiumstore'),
  JWT_SECRET: z.string().min(16).default('premiumstore-build-placeholder-jwt-secret'),
  JWT_COOKIE_NAME: z.string().min(1).default('premiumstore_token'),
  JWT_EXPIRES_IN: z.string().min(1).default('7d'),
  BETTER_AUTH_SECRET: z.string().min(16).default('premiumstore-build-placeholder-better-auth-secret'),
